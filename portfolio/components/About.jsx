...
const About = () => {
    return (
        <div id='aboutme' className='w-full px-[12%] py-10 scroll-mt-20'>
            <h4 className='text-center mb-2 text-lg font-Ovo'>Indroduction</h4>
            ...
            <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                <div className='flex-1'>
                    ...
                    >Hi, I'm Asangika Liyanaarachchi, an undergraduate specializing in Information
                        Technology at the University of Moratuwa. I’m a dedicated full-stack developer with a passion for building
                        impactful web and mobile applications.With a blend of creativity and technical know-how,
                    ...
                    <ul className='flex items-center gap-3 sm:gap-5'>
                        {toolsData.map((tool,index)=>(
                            ...
                            sm:w-14 aspect-square border border-gray-400 rounded-lg corsor-pointer
